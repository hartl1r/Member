...
class Member(db.Model):
    ...
    LFM_Name = db.Column(db.String(32))
    FML_Name = db.Column(db.String(32))
    LF_Name = db.Column(db.String(32))
    LFN_Name = db.Column(db.String(32))
    FNL_Name = db.Column(db.String(32))
